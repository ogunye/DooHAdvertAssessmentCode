...
namespace DooHAdvertAPI.Migrations
{
    ...
    [Migration("20230704040336_ModifedSeedDatabase")]
    partial class ModifedSeedDatabase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DooHAdvertAPI.Models.Adverts", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Priority = 9,
                            StartTime = new DateTime(2023, 7, 4, 5, 3, 36, 757, DateTimeKind.Local).AddTicks(4235)
                        },
                        new
                        {
                            Id = 2,
                        ...
                        new
                        {
                            ...
                            Path = "Resources/Images/Solaris Solar",
                            Priority = 9,
                            StartTime = new DateTime(2023, 7, 4, 5, 3, 36, 757, DateTimeKind.Local).AddTicks(4305)
                        },
                        new
                        {
                            Id = 9,
                            ...
                            Path = "Resources/Images/AeroTech Drones",
                            Priority = 9,
                            StartTime = new DateTime(2023, 7, 4, 5, 3, 36, 757, DateTimeKind.Local).AddTicks(4308)
                        },
                        new
                        {
                            Id = 10,
